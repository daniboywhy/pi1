    ...
    <div className="usersidebar">
      ...
      {userData.tipoUsuario === "tutor" && (
        activepage === "minhasturmas" ? (
          ...
          <Link to="/profile/minhasturmas" className="stylenone">
            <div className="s1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
      ...
      {userData.tipoUsuario === "aluno" && ( activepage === "alunoturmas" ? (
        <div className="s2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
        ...
        <Link to="/profile/alunoturmas" className="stylenone">
          <div className="s1">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="16"
